...
public class MainFrameGUI extends javax.swing.JFrame {
    ...
    public MainFrameGUI(String employeeID) {
        this.setSize(1200, 700);
        this.setLocationRelativeTo(null);
        initComponents();
        this.setResizable(false);
        JPanelMenu menu = new JPanelMenu(this, employeeID);
        panelMenu.add(menu);
        JPanelOrder orderGUI = new JPanelOrder(employeeID);
        panelMainFrame.add(orderGUI);
    }
    ...
    public void setjPanelMenu(JPanel panelMenu) {

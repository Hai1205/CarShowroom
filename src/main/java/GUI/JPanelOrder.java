...
public class JPanelOrder extends javax.swing.JPanel {
    ...
    private int seatProduct, quantityProduct;
    ...
    private void jTableOrderMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTableOrderMouseClicked
        ...
        idProduct = invoiceTable.getValueAt(row, 0).toString();
        nameProduct = invoiceTable.getValueAt(row, 1).toString();
        typeProduct = invoiceTable.getValueAt(row, 2).toString();
        seatProduct = Integer.parseInt(invoiceTable.getValueAt(row, 3).toString());
        quantityProduct = Integer.parseInt(invoiceTable.getValueAt(row, 4).toString());
        priceProduct = Double.parseDouble(invoiceTable.getValueAt(row, 5).toString());
